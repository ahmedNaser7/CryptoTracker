...
import com.example.cryptotracker.crypto.presentation.model.toDisplayNumber
        ...
        Column(
            ...
            FlowRow(
                ...
                InfoCard(
                    ...
                    formatedText = "$ ${coin.marketUsdPrice.formatted}",
                ...
                val absoluteChangeFormatted =
                    (coin.priceUsd.value * (coin.changedPercent24Hr.value / 100))
                        .toDisplayNumber()
                val isPositive = coin.changedPercent24Hr.value > 0.0
